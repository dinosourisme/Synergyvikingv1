export const productDetails = {
  ...
  • Comms – AMRON – 3 Diver air radio / unscramble radio
  • Video systems – for Diver 1 / Diver 2 / Diver 3 (or Diver 1 and Diver 2) as per client requirement
  • Cylinder air bank – 12 cylinder plumbed either to Dive panel with ss tubing
  • External Charging point for cylinders
  • Dive supervisor work bench, cupboards, file storage
  • All plumbing tungum
  ...
  • Full redundancy on all critical systems
  • DNV or Bureau Veritas classification
  • Integrated gas distribution panel
